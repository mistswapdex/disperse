...
const Payment = ({ address }) => {
  ...
  return (
    <div className="pt-16">
      <h3 className="text-xl font-light font-family monospace">
        send
        <span
          onClick={() => setCurrentLink("WDOGE")}
          className={`border-gray-600 border-b-2 ${
            currentLink !== "WDOGE" ? "text-gray-500" : ""
          }`}
        >
          {" "}
          WDOGE{" "}
      ...
      {currentLink === "WDOGE" && <Ether address={address} />}
      {currentLink === "token" && (
        <div className="mt-12 mb-24">
          <h3 className="text-xl font-light">token address</h3>
          ...
          {isTokenLoading && (
            <p className="pt-4 text-l font-light font-family monospace">
              loading token info ...
            </p>
          )}
          {!isTokenLoading && tokenDetails.name && (
            <>
              ...
              {warn && <p className=" text-red-400">{warn}</p>}
              {!warn && (
                <Recipients
